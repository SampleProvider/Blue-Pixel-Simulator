...
colors[GRAVEL] = [130, 130, 110, 100, 100, 90];
colors[CLAY] = [180, 100, 90, 130, 80, 80];
colors[SILT] = [200, 130, 120, 150, 120, 120];
...
colors[WET_ASH] = [100, 100, 110, 70, 70, 80];
...
colors[IRON] = [120, 120, 90, 175, 175, 145];
colors[METAL] = ["rgb(165, 165, 165)", "rgb(155, 155, 155)"];
colors[CONCRETE_POWDER] = "rgb(125, 125, 125)";
colors[CONCRETE] = "rgb(75, 75, 75)";
